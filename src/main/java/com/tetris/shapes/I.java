...
public class I extends Shape {
    public I(int blockSize, int maxWidth, int maxHeight, GameLogic gameLogic) {
        ...
        this.blocks[0] = new Block(blockSize, Color.CYAN);
        this.blocks[0].setPos(new Position(maxWidth / 2 - 1, 0));
        this.blocks[1] = new Block(blockSize, Color.CYAN);
        this.blocks[1].setPos(new Position(maxWidth / 2 - 1, 1));
        this.blocks[2] = new Block(blockSize, Color.CYAN);
        this.blocks[2].setPos(new Position(maxWidth / 2 - 1, 2));
        this.blocks[3] = new Block(blockSize, Color.CYAN);
