...
public class Z extends Shape {
    public Z(int blockSize, int maxWidth, int maxHeight, GameLogic gameLogic) {
        super(blockSize, maxWidth, maxHeight,gameLogic);
        this.blocks[0] = new Block(blockSize, Color.RED);
        this.blocks[0].setPos(new Position(maxWidth / 2 - 1, 0));
        this.blocks[1] = new Block(blockSize, Color.RED);
        this.blocks[1].setPos(new Position(maxWidth / 2, 0));
        this.blocks[2] = new Block(blockSize, Color.RED);
        this.blocks[2].setPos(new Position(maxWidth / 2, 1));
        this.blocks[3] = new Block(blockSize, Color.RED);
